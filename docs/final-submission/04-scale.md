...
| Live-location Broadcast (+ optional snapshot upsert on native/Edge path) | Extra messages/writes while handoffs are active |
...
- Live-location traffic is scoped to **active claim** private topics, not global GPS broadcast.
